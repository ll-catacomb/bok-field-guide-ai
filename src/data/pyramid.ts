...
export const TIERS: Tier[] = [
  {
    ...
    practices: [
      ...
      "Write questions and prompts with precise, higher-order action verbs like “critique,” “design,” or “compare,” not vague ones like “discuss” or “list” (see Bloom's taxonomy).",
